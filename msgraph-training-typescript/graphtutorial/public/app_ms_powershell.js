...
// Uses MSAL.js with Microsoft Graph PowerShell client ID (pre-approved)

// MSAL configuration using Microsoft Graph PowerShell client ID
const msalConfig = {
    auth: {
        clientId: '14d82eec-204b-4c2f-b7e8-296a70dab67e', // Microsoft Graph PowerShell (often pre-approved)
